...
class ListMerchantInvoicesRequest(_message.Message):
    __slots__ = ("merchant_id", "status", "page_size", "page_token")
    MERCHANT_ID_FIELD_NUMBER: _ClassVar[int]
    STATUS_FIELD_NUMBER: _ClassVar[int]
    PAGE_SIZE_FIELD_NUMBER: _ClassVar[int]
    PAGE_TOKEN_FIELD_NUMBER: _ClassVar[int]
    ...
    page_size: int
    page_token: str
    def __init__(self, merchant_id: _Optional[int] = ..., status: _Optional[_Union[_common_pb2.InvoiceStatus, str]] = ..., page_size: _Optional[int] = ..., page_token: _Optional[str] = ...) -> None: ...
