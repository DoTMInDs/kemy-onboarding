...
class Transaction(_message.Message):
    ...
    def __init__(self, id: _Optional[str] = ..., merchant_id: _Optional[int] = ..., provider_id: _Optional[str] = ..., invoice_number: _Optional[str] = ..., account_no: _Optional[str] = ..., external_reference_id: _Optional[str] = ..., amount: _Optional[_Union[Money, _Mapping]] = ..., currency: _Optional[str] = ..., type: _Optional[str] = ..., status: _Optional[str] = ..., is_completed: bool = ..., metadata: _Optional[_Mapping[str, str]] = ..., created_at: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., updated_at: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., completed_at: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ...) -> None: ...
...
class TransactionFilter(_message.Message):
    ...
    limit: int
    account_no: str
    def __init__(self, merchant_id: _Optional[int] = ..., provider_id: _Optional[str] = ..., status: _Optional[str] = ..., payment_method: _Optional[str] = ..., to: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., invoice_number: _Optional[str] = ..., reference_id: _Optional[str] = ..., limit: _Optional[int] = ..., account_no: _Optional[str] = ..., **kwargs) -> None: ...
